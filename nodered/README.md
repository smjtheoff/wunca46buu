...
**Scenario:** ระบบ IoT ที่ต้องการข้อมูล network monitoring แบบ real-time พร้อมแสดงบนแผนที่ 3 มิติ

```
LibreNMS API → Node-RED → MQTT Broker (Aedes) → 3D Map Platform
```

**ตัวอย่างการใช้งาน:**
- 🗺️ แผนที่ 3D แสดงสถานะ network แบบ real-time
